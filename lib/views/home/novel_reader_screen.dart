...
class _NovelReaderScreenState extends State<NovelReaderScreen> {
  ...
  double get _readProgress =>
      _requiredSeconds == 0 ? 1.0 : (_secondsRead / _requiredSeconds).clamp(0.0, 1.0);
  ...
  Future<void> _toggleLike() async {
    ...
    if (mounted) setState(() { _isLiked = !_isLiked; _isLikeLoading = false; });
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // تعليق إلزامي
                Text('التعليق (50 حرف على الأقل — إلزامي)',
                    style: GoogleFonts.cairo(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: tempRating == 0 ? null : () async {
                      if (_ratingCommentController.text.trim().length < 50) {
  ...
  Future<void> _submitRating(int rating) async {
    ...
    if (allChapters.docs.isNotEmpty) {
      final novelAvg = allChapters.docs
              .fold<double>(0, (s, d) =>
                  s + ((d.data()['rating'] ?? 0.0) as num).toDouble()) /
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('شكراً على تقييمك! +10 نقاط ⭐',
            style: GoogleFonts.cairo()),
        backgroundColor: Colors.amber,
      ));
    }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _typeChip('تصحيح إملائي', 'spelling', reqType, (v) => setS(() => reqType = v), theme),
                    const SizedBox(width: 8),
                    _typeChip('إزالة مخالفة',  'violation', reqType, (v) => setS(() => reqType = v), theme),
                  ],
                ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if (ctx.mounted) {
                        Navigator.pop(ctx);
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text('تم إرسال طلبك للدعم ✅',
                              style: GoogleFonts.cairo()),
  ...
  Widget _typeChip(String label, String value, String current,
      void Function(String) onTap, ThemeData theme) {
                    ...
                    onPressed: selectedReason == null
                        ...
                        : () async {
                            ...
                            if (ctx.mounted) {
                              Navigator.pop(ctx);
                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text('تم إرسال تبليغك، شكراً! 🙏',
                                    style: GoogleFonts.cairo()),
                                backgroundColor: Colors.green,
                              ));
                            }
                ...
                builder: (_, snap) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final name = d['authorName'] ?? d['authorEmail'] ?? 'مجهول';
                      return Padding(
              ...
              child: Row(
                children: [
                  ...
                  _isPostingComment
                      ...
                      : IconButton(
                          onPressed: () async { await _postComment(); },
            ...
            itemBuilder: (_) => [
              PopupMenuItem(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: 8),
                    Text('تبليغ عن محتوى', style: GoogleFonts.cairo(fontSize: 13)),
                  ])),
              PopupMenuItem(
                  value: 'support',
                  child: Row(children: [
                      ...
                      if (!_canRate) ...[
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            onPressed:
                                _isRatingLoading ? null : _showRatingSheet,
                        ...
                        Container(
                          ...
                          child: Row(children: [
                            ...
                            const SizedBox(width: 8),
                            Text('قيّمت هذا الفصل بـ $_userRating نجوم ⭐',
                                style: GoogleFonts.cairo(
                                    fontSize: 13,
                                    color: Colors.green,
                                    fontWeight: FontWeight.bold)),
      ...
      bottomNavigationBar: StreamBuilder<DocumentSnapshot>(
        stream: _novelId.isEmpty
            ...
            : FirebaseFirestore.instance
                  .collection('novels').doc(_novelId).snapshots(),
        builder: (_, snap) {
          final data = snap.hasData && snap.data!.exists
              ? snap.data!.data() as Map<String, dynamic>
              : <String, dynamic>{};
          final likesCount   = (data['likes']   ?? 0).toString();
