  ...
  _NotifStyle _getStyle(String type) {
    switch (type) {
      ...
      case 'friend_recommendation': // #23
        return _NotifStyle(Icons.recommend_rounded, const Color(0xFFC4A87A), 'ترشيح رواية من صديق');
      case 'admin_warning':
      ...
      case 'novel_completed':
        return _NotifStyle(Icons.auto_stories_rounded, const Color(0xFFC4A87A), 'رواية اكتملت');
      case 'friend_reading':
